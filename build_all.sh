...
"${SCRIPT_DIR}/build_zlib_ng.sh" "${BUILD_ARG}"
"${SCRIPT_DIR}/build_bzip2.sh" "${BUILD_ARG}"
"${SCRIPT_DIR}/build_brotli.sh" "${BUILD_ARG}"

# 2. libpng 빌드 (zlib-ng 의존)
"${SCRIPT_DIR}/build_libpng.sh" "${BUILD_ARG}"

# 3. libjpeg-turbo 빌드
"${SCRIPT_DIR}/build_libjpeg_turbo.sh" "${BUILD_ARG}"

# 4. libjxl 빌드
"${SCRIPT_DIR}/build_libjxl.sh" "${BUILD_ARG}"
