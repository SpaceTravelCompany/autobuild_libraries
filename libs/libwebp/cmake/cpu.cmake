...
if(MSVC AND CMAKE_C_COMPILER_ID STREQUAL "MSVC")
  ...
  # Use single space for NEON slot so SIMD_ENABLE_FLAGS has no ";;" (avoids clang-cl /Fo multiple-sources error).
  set(NEON_ENABLE_FLAG "-mfpu=neon")
  if(WEBP_ARM64_BUILD OR CMAKE_SYSTEM_PROCESSOR MATCHES "[aA]arch64")
    set(NEON_ENABLE_FLAG " ")
  endif()
  if(CMAKE_C_FLAGS MATCHES "--target=aarch64")
    set(NEON_ENABLE_FLAG " ")
  endif()
  set(SIMD_ENABLE_FLAGS
